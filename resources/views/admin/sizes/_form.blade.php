    ...
    @foreach ($langs as $lable => $lang)
        <div class="col-sm-4">
            <div class="form-group {{($errors->first($lable.'.name')) ? 'has-error' :''}}">
                <label class="control-label" for="sizes_name">{{ __('Name')}} {{ '('.$lang.')' }}</label> :<span class="require">*</span>
                {!! Form::text($lable.'[name]', ($result != '' ? $result->translate($lable)->name : null) ,['class'=>'form-control required','id'=>"sizes_name"]) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group {{($errors->first('code')) ? 'has-error' :''}}">
                <label class="control-label" for="sizes_code">{{ __('code')}}</label> :<span class="require">*</span>
                {!! Form::text('code', ($result != '' ? $result->code : null) ,['class'=>'form-control required','id'=>"sizes_code"]) !!}
                @if($errors->has('code'))
