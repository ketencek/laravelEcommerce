...
@section('content')
    ...
    <h3 class="page-title">{{ $label }}
        <div class="pull-right">
            <a class="btn btn-site" role="button" href="{{ route('admin.blogs.create', ['type' => $type]) }}"><i
                            ...
                            @foreach ($blogs as $k1 => $blc)
                                <tr id="row-{{ $blc['id'] }}" class="row-move">
                                    ...
                                    <td class="text-center action_div">
                                        @include('admin.general.action_btn', ['id' => $blc->id, 'route' => 'admin.blogs',
                                        'type'=>$type])
                                    </td>
                                </tr>
                            @endforeach
