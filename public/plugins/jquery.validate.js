  ...
  $.extend($.validator, {
    ...
    messages: {
      ...
      tr: {
        ...
        equalTo: "Şifre eşleşmiyor tekrar deneyiniz.",
    ...
    prototype: {
      ...
      defaultMessage: function (element, method) {
        return this.findDefined(
          ...
          $.validator.messages[this.settings.lang][method],
